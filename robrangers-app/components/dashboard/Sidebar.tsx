      ...
      <div className="border-t border-neutral-200/50 pt-6 mt-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col">
            <span className="text-[11px] font-bold text-[#1D1D1F] truncate max-w-[120px]" title={user?.name}>
              {user?.name || "Ranger"}
            </span>
            <span className="text-[9px] text-[#86868B] uppercase tracking-wider font-semibold">
              Ranger Level {user?.level || 1}
            </span>
          </div>
        </div>
