...
const InputField = ({ label, icon: Icon, value, onChange, type = "text" }: InputFieldProps) => {
    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="relative flex items-center">
        ...
        <input
          ...
          className="w-full pl-11 pr-4 py-3 rounded-xl border-none text-xs placeholder-neutral-400 focus:outline-none bg-[#F5F5F7]/40 relative z-0"
        />
      </div>
    </div>
  );
...
export default function ProfileTab() {
  const [name, setName] = useState("Ghonni Faza");
