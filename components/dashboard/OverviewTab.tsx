...
export default function OverviewTab() {
  ...
  const welcomeWords = "Selamat Datang, Ranger Ghonni! 👋".split(" ");
      ...
      >
        ...
        >
          <div className="flex justify-between items-start mb-4">
            <div className="flex flex-col">
              ...
              <h3 className="text-lg font-extrabold text-[#1D1D1F]">Level 12 - Intermediate</h3>
            </div>
          ...
          >
            <div className="flex justify-between text-xs font-semibold">
              ...
              <span className="text-[#1D1D1F] font-mono">{xp.toLocaleString()} / 3,000 XP</span>
            </div>
          ...
          <div className="border-t border-neutral-100 pt-4 mt-4 flex items-center justify-between text-[10px] text-[#86868B] font-semibold uppercase tracking-wider">
            <span>Tersisa 550 XP menuju Level 13</span>
          </div>
        </motion.div>
        ...
        >
          ...
          >
            ...
            {[
              { title: "Dasar Variabel & Loop", date: "Kemarin", status: "Selesai" },
              { title: "Mengenal Workspace & Parts", date: "3 hari lalu", status: "Selesai" },
              { title: "Instalasi Roblox Studio", date: "Minggu lalu", status: "Selesai" }
            ].map((item, idx) => (
              <motion.div 
                key={idx} 
                variants={listItem}
