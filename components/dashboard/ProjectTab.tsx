    ...
    const interval = setInterval(() => {
      setUploadProgress(prev => {
        ...
        if (prev >= 100) {
          ...
          setTimeout(() => {
            setAiReport(
              "🤖 Penilaian AI: Proyek terverifikasi!\nSistem mendeteksi 3 skrip server-side, 2 platform bergerak dengan loop, dan 1 sistem koin leaderboard.\nSkor Kualitas Script: 85% - Lolos Kriteria Kelulusan."
            );
                  ...
                  >
                    ...
                    <div className="p-4 flex justify-between items-center bg-white/95 relative z-10 border-b border-neutral-100">
                      ...
                      <div className="flex items-center gap-3 shrink-0">
                        ...
                        >
                          <Heart className={`w-4.5 h-4.5 ${proj.isLiked ? "fill-current" : ""}`} />
                        </button>
                      </div>
                    </div>
